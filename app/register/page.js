      ...
      <div style={styles.mainContainer}>
        ...
        <div style={styles.authForm}>
          ...
          <div style={styles.formHeader}>
            ...
            <p style={styles.formSubtitle}>Join us today</p>
          </div>
          ...
          <form id="registerForm" onSubmit={handleSubmit}>
            ...
            <div style={styles.formGroup}>
              <label htmlFor="registerMobile" style={styles.label}>Mobile</label>
              <input
                type="tel"
                id="registerMobile"
            ...
            <button 
              ...
              style={{
                ...
                ...(hoverStates.registerBtn && !isLoading ? styles.buttonHover : {}),
                ...(isLoading ? styles.buttonDisabled : {})
              }}
              onMouseEnter={() => !isLoading && handleMouseEnter('registerBtn')}
              onMouseLeave={() => !isLoading && handleMouseLeave('registerBtn')}
            >
          ...
          <div style={styles.switchForm}>
            ...
            <Link 
              ...
              style={{
                ...styles.link,
                ...(hoverStates.loginLink ? styles.linkHover : {})
              }}
              onMouseEnter={() => handleMouseEnter('loginLink')}
              onMouseLeave={() => handleMouseLeave('loginLink')}
            >
              Sign in
            </Link>
          </div>
